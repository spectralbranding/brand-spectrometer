# Methodology — Brand Spectrometer v0.1

*Companion to `schema/atlas_schema_v0.1.yaml` (v0.1) and `SCHEMA_DESIGN_NOTES.md`. Methodology version: 0.1.0.*
